...
// Route::middleware(['RoleMiddleware:AdminTechnicianStore'])->group(function () {
//     Route::get('/noti', [NotiRepairController::class, 'checkNotiRepair'])->name('noti.list');
//     // เปลี่ยนชื่อเป็นรับเข้า Store
//     Route::post('/noti/accept-to-store/{notirepairid}', [NotiRepairController::class, 'adminAcceptToStore'])->name('noti.admin_accept'); 
//     Route::post('/updaterecive', [NotiRepairController::class, 'updateStatus'])->name('notiupdate');
//     // ... อื่นๆ ...
// });

// // ฝั่งหน้าร้าน (ธิวาพร และเพื่อนร่วมสาขา)
// Route::middleware(['RoleMiddleware:Frontstaff'])->group(function () {
//     Route::get('/noti/storefront', [NotiRepairController::class, 'getNotiForStoreFront'])->name('noti.storefront');
//     // ปุ่มรับของคืนเมื่อซ่อมเสร็จ
//     Route::post('/noti/receive-back/{notirepairid}', [NotiRepairController::class, 'receiveBackToBranch'])->name('noti.receive_back');
//     // ปุ่มปิดงาน
//     Route::post('/noti/close/{notirepairid}', [NotiRepairController::class, 'closedJobs'])->name('noti.close');
// });
//officer
