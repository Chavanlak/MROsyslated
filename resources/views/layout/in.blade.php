                            ...
                            <td class="dt-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    @if ($status === 'ยังไม่ได้รับของ')
                                        ...
                                        <form action="{{ route('interior.reject', $item->NotirepairId) }}" method="POST"></form>
                                            @csrf
                                            <button type="submit"
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <div class="d-flex gap-2">
                                @if ($status === 'ยังไม่ได้รับของ')
                                    {{-- <form action="{{ route('noti.accept', $item->NotirepairId) }}" method="POST"> --}}
                                        <form action="{{ route('interior.accept', $item->NotirepairId) }}" method="POST"></form>
                                        @csrf
