                                ...
                                <td>
                                    @if ($job->received_at)
                                        <div class="small fw-medium text-dark">
                                            ...
                                            {{ date('d/m/Y H:i', strtotime($job->received_at)) }}
                                        </div>
                                    @else
                                ...
                                <td>
                                    @if ($job->closedJobs !== 'ยังไม่ปิดงาน')
                                        <div class="text-success fw-bold small">
                                            ...
                                            {{ date('d/m/Y H:i', strtotime($job->DateCloseJobs)) }}
                                        </div>
                ...
                <div class="card mb-3 border-0 shadow-sm"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-muted">วันที่รับของ:</span>
                            <span class="fw-medium text-dark">
                                {{ $job->received_at ? date('d/m/y H:i', strtotime($job->received_at)) : '-' }}
                            </span>
                        </div>
